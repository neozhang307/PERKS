...
template<class REAL>
int j3d_iterative(REAL*, int, int, int, REAL*, int, int, int, bool, bool, int, bool getminHeight=false);

#define PERKS_DECLARE_INITIONIZATION_ITERATIVE(_type) \
    int j3d_iterative(_type*,int,int, int,_type*, int, int, int, bool, bool, int, bool);
