  ...
  int max_sm_flder)
{
  ...
  regfolder<halo,isstar,registeramount,PERKS_ARCH,UseSMCache,REAL>::val, 
  // 1, 
...
PERKS_INITIALIZE_ALL_TYPE_4ARG(PERKS_DECLARE_INITIONIZATION_GENERAL_WRAPPER,RTILE_Y,HALO,128,true);
PERKS_INITIALIZE_ALL_TYPE_4ARG(PERKS_DECLARE_INITIONIZATION_GENERAL_WRAPPER,RTILE_Y,HALO,128,false);
PERKS_INITIALIZE_ALL_TYPE_4ARG(PERKS_DECLARE_INITIONIZATION_GENERAL_WRAPPER,RTILE_Y,HALO,256,true);
PERKS_INITIALIZE_ALL_TYPE_4ARG(PERKS_DECLARE_INITIONIZATION_GENERAL_WRAPPER,RTILE_Y,HALO,256,false);
// #if PERKS_ARCH==800
// #elif PERKS_ARCH==700
// #elif PERKS_ARCH==600
