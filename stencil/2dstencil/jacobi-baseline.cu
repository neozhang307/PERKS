...
// #endiif
      ...
      #ifdef SMASYNC
        #ifndef PERSISTENT
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_ASYNC,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_ASYNC,16,HALO);
        #else
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_ASYNC,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_ASYNC,16,HALO);
        #endif
      #else 
        #ifndef PERSISTENT
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE,16,HALO);
        #else
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE,16,HALO);
        #endif
      #endif 
  #else
      #ifdef SMASYNC
        #ifndef PERSISTENT
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_BOX_ASYNC,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_BOX_ASYNC,16,HALO);
        #else
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_BOX_ASYNC,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_BOX_ASYNC,16,HALO);
        #endif
      #else 
        #ifndef PERSISTENT
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_BOX,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_BASELINE_BOX,16,HALO);
        #else
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_BOX,8,HALO);
            PERKS_INITIALIZE_ALL_TYPE_2ARG(PERKS_DECLARE_INITIONIZATION_PBASELINE_BOX,16,HALO);
        #endif
      #endif
  #endif
#else
